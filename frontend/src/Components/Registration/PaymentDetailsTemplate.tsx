...
const PaymentDetailsTemplate: React.FC<PaymentDetailsProps> = ({ data }) => {
  const calculateTotals = () => {
    const subtotal = data.services.reduce((sum, service) => sum + service.total, 0);
      ...
      <Page size="A4" style={styles.page}>
          ...
          <View style={styles.table}>
            ...
            {data.services.map((service, index) => (
              <View key={index} style={styles.tableRow}>
                ...
                <Text style={styles.col3}>��{service.unitPrice.toFixed(2)}</Text>
        ...
        <View style={styles.totalsSection}>
          ...
          <View style={styles.totalRow}>
            ...
            <Text style={styles.totalValue}>₹{data.paymentDetails.amount.toFixed(2)}</Text>
          </View>
