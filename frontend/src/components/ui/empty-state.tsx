  ...
  return (
    <div
      className={cn(
        ...
        "border-2 border-dashed rounded-xl p-14 w-full flex flex-col",
        "group hover:bg-muted/50 transition duration-500 hover:duration-200 justify-center items-center",
        className
      )}
    >
      ...
      <p className="text-sm text-muted-foreground mt-1 whitespace-pre-line mb-6">
        {description}
      </p>
      {/* {action && (
        <Button
